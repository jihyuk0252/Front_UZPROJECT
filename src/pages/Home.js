            ...
            <div className="wrapper">
                <div className="home_1">
                    ...
                    <div className="home_1_links">
                        ...
                        <button type="button" className="home_1_link" onClick={() => window.open('notice')}>
                        ...
                        <button type="button" className="home_1_link" onClick={() => window.open('login')}>
                        ...
                        <button type="button" className="home_1_link" onClick={() => window.open('http://인력사무소.kro.kr', '_blank')}>
